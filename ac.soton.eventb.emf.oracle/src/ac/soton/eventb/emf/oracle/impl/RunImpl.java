 ...
 * <ul>
 *   <li>{@link ac.soton.eventb.emf.oracle.impl.RunImpl#getEntries <em>Entries</em>}</li>
 *   <li>{@link ac.soton.eventb.emf.oracle.impl.RunImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RunImpl extends EObjectImpl implements Run {
	...
	protected EClass eStaticClass() {
		return OraclePackage.Literals.RUN;
	}
	...
	public EList<Entry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentEList<Entry>(Entry.class, this, OraclePackage.RUN__ENTRIES);
		}
		return entries;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OraclePackage.RUN__NAME, oldName, name));
	}
