 ...
 * <ul>
 *   <li>{@link ac.soton.eventb.emf.oracle.impl.StepImpl#getName <em>Name</em>}</li>
 *   <li>{@link ac.soton.eventb.emf.oracle.impl.StepImpl#getArgs <em>Args</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StepImpl extends EntryImpl implements Step {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return OraclePackage.Literals.STEP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OraclePackage.STEP__NAME, oldName, name));
	}
	...
	public EList<String> getArgs() {
		if (args == null) {
			args = new EDataTypeEList<String>(String.class, this, OraclePackage.STEP__ARGS);
		}
		return args;
	}
