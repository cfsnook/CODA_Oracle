...
/**
 * This is the item provider adapter for a {@link ac.soton.eventb.emf.oracle.Step} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StepItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_Name_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_Name_feature", "_UI_Step_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 OraclePackage.Literals.STEP__NAME,
				 true,
				 false,
				 false,
	...
	protected void addArgsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_Args_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_Args_feature", "_UI_Step_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 OraclePackage.Literals.STEP__ARGS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Step.class)) {
			case OraclePackage.STEP__NAME:
			case OraclePackage.STEP__ARGS:
